...
Finally, assign a new password to your vault. It is the same process as the [vault creation](/desktop/adding-vaults/.md#choose-a-password), except that no new recovery key is generated. Again, please choose a [strong password](/security/best-practices/.md#good-passwords).
