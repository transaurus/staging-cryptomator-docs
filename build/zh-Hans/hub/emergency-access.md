...
* **New vaults:** During vault creation, use the `Define Emergency Access Conditions` step. For the full workflow, see [Vault Management](/zh-Hans/hub/vault-management/.md#create-a-vault).
* **Existing vaults:** Open `Vault Details` and [configure Emergency Access](/zh-Hans/hub/vault-management/.md#emergency-access-council).
...
![Emergency Access Vault List](/zh-Hans/img/hub/emergency_access_vault_list.png)
...
| Change how many council approvals are required (threshold) | Configurable in the [admin settings](/zh-Hans/hub/admin/.md#emergency-access) |
...
![Emergency Access Vault List](/zh-Hans/img/hub/emergency_access_change_permissions_start.png)
...
The minimum required number of members is configured in the [Admin settings](/zh-Hans/hub/admin/.md#emergency-access).

![Emergency Access Vault List](/zh-Hans/img/hub/emergency_access_change_council_start.png)
...
![Emergency Access Vault List Approve Now](/zh-Hans/img/hub/emergency_access_vault_list_change_council_approve_now.png)
...
![Emergency Access Vault List Approve Dialog](/zh-Hans/img/hub/emergency_access_vault_list_change_council_approve_dialog.png)
...
![Emergency Access Vault List Hover Process](/zh-Hans/img/hub/emergency_access_vault_list_hover_process.png)
...
![Emergency Access Vault List Complete Now](/zh-Hans/img/hub/emergency_access_vault_list_change_council_complete_now.png)
...
![Emergency Access Vault List Complete Dialog](/zh-Hans/img/hub/emergency_access_vault_list_change_council_complete_dialog.png)
...
![Emergency Access Vault List Abort Dialog](/zh-Hans/img/hub/emergency_access_vault_list_change_council_abort_dialog.png)
...
See [Emergency Access Audit Log events](/zh-Hans/hub/admin/.md#event-type-emergency-access).
