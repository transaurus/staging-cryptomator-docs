...
Afterwards you're done. You can now login to Cryptomator Hub and start [creating vaults](/zh-Hans/hub/vault-management/.md) or [add users](/zh-Hans/hub/user-group-management/.md).
