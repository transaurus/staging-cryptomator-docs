...
![Vault list add drop down](/zh-Hans/img/hub/vault-onlinerecovery-step1.png)
...
![Vault enter recovery key](/zh-Hans/img/hub/vault-onlinerecovery-step2.png)
...
![Creating a vault using recovery key](/zh-Hans/img/hub/vault-onlinerecovery-step3.png)
...
## Offline Recovery[​](#offline-recovery "Direct link to Offline Recovery")
...
![Vault recovery convert to Password-Based-Vault](/zh-Hans/img/hub/vault-offlinerecovery-step1.png)
...
![Convert vault enter recovery key](/zh-Hans/img/hub/vault-offlinerecovery-step2.png)

In the next step choose a [good password](/zh-Hans/security/best-practices/.md#good-passwords) used for unlocking the vault. Cryptomator requires at least 8 characters but we recommend you to use a longer phrases such as pass-sentences. The bar below the password field estimates the strength of your password.

![Convert vault enter new password](/zh-Hans/img/hub/vault-offlinerecovery-step3.png)
...
![Convert vault successful](/zh-Hans/img/hub/vault-offlinerecovery-step4.png)
...
![Unlock converted Vault](/zh-Hans/img/hub/vault-offlinerecovery-step5.png)
