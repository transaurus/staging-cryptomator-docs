...
![How to launch settings with Android](/zh-Hans/img/android/launch-settings.png)![How to launch settings with Android](/zh-Hans/img/android/settings.png)
...
![How to handle cloud services with Android](/zh-Hans/img/android/setting-cloud-services.png)

### Fingerprint[​](#fingerprint "Direct link to Fingerprint")
...
![How to use fingerprint with Android](/zh-Hans/img/android/setting-fingerprint-0-setup.png)![How to use fingerprint with Android](/zh-Hans/img/android/setting-fingerprint-1-enter-pw.png)

After enabling, you have to unlock the vault using the password.

![How to use fingerprint with Android](/zh-Hans/img/android/setting-fingerprint-2-authenticate.png)![How to use fingerprint with Android](/zh-Hans/img/android/setting-fingerprint-3-finish.png)

To have access to the key stored in the keystore, you have to authenticate against the system using the fingerprint.

### Block App When Obscured[​](#block-app-when-obscured "Direct link to Block App When Obscured")
...
If you want to disable protection, the blue light filter or any app obscuring Cryptomator has to be disabled one time. Afterwards, the settings can be opened and the option "Disable app when obscured" can be disabled. And then the relevant apps can be re-enabled again.
...
![How to enable obscured app with Android](/zh-Hans/img/android/setting-app-obscured.png)

### Screen Security[​](#screen-security "Direct link to Screen Security")
...
![How to change style with Android](/zh-Hans/img/android/settings.png)![How to change style with Android](/zh-Hans/img/android/setting-style-dark.png)
...
### Live Search[​](#live-search "Direct link to Live Search")
...
![How to use live search with Android](/zh-Hans/img/android/search.gif)

If it is disabled, you have to use the magnifier or the enter button in your keyboard to start the search.

### Search using glob pattern matching[​](#search-using-glob-pattern-matching "Direct link to Search using glob pattern matching")

If this setting is enabled, you have to enter a glob pattern into the search bar.

![How to use live search with Android](/zh-Hans/img/android/search-glob-pattern.gif)
...
## Automatic Locking[​](#automatic-locking "Direct link to Automatic Locking")
...
## Automatic Photo Upload[​](#automatic-photo-upload "Direct link to Automatic Photo Upload")
...
### Cache Size Per Cloud[​](#cache-size-per-cloud "Direct link to Cache Size Per Cloud")
...
### Workaround Opening Microsoft Files[​](#workaround-opening-microsoft-files "Direct link to Workaround Opening Microsoft Files")
...
### Keep Unlocked[​](#keep-unlocked "Direct link to Keep Unlocked")
...
### Accelerate Unlock[​](#accelerate-unlock "Direct link to Accelerate Unlock")
...
### Update Check Interval[​](#update-check-interval "Direct link to Update Check Interval")
