...
## Virtual Filesystem[​](#virtual-filesystem "Direct link to Virtual Filesystem")
...
## Vault Configuration[​](#vault-configuration "Direct link to Vault Configuration")
...
## Masterkey[​](#masterkey "Direct link to Masterkey")
...
When using [Cryptomator Hub](/zh-Hans/hub/access-vault/.md), the encrypted raw masterkey can be retrieved from a the server component.
...
### Masterkey File[​](#masterkey-file "Direct link to Masterkey File")
...
![KEK Derivation](/zh-Hans/img/security/key-derivation.png)
...
![Masterkey Decryption](/zh-Hans/img/security/masterkey-decryption.png)
