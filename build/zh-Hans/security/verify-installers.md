...
## GPG Signature[​](#gpg-signature "Direct link to GPG Signature")
...
![How to verify GPG signatures](/zh-Hans/img/security/verify-gpg-signature.png)
...
## Windows (exe, msi)[​](#windows "Direct link to Windows (exe, msi)")

Our Windows installers are signed using a code signing certificate. You can verify the signature in five simple steps:

![How to check the code signing certificate on Windows](/zh-Hans/img/security/verify-win-installer.png)
...
## macOS (app)[​](#macos "Direct link to macOS (app)")
