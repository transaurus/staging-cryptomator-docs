...
This feature is only available for [Cryptomator Hub](/zh-Hans/hub/introduction/.md) vaults.
...
![Cryptomator notification for a file currently in use](/zh-Hans/img/desktop/files-in-use-notification.png)
...
* [Synchronization Conflicts](/zh-Hans/desktop/sync-conflicts/.md)
